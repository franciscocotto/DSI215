...
public class addVenta {
       ...
       public void agrega(ventas venta){
           //conexion a la base de datos
            ...
            con.conectar();
            //INSERT SQL
            String sql = "INSERT INTO public.\"ventas\" (nombre,descripcion,cantidad,precio,forma_de_pago,estado,abono,total_pago)"+"VALUES(?,?,?,?,?,?,?,?)";
            String status = "";
      ...
      // metodo para eliminar  registros en la base de datos 
       public void elimina(ventas venta) throws SQLException{
           //conexion a base de datos 
            ...
            stmt.execute( "DELETE FROM public.\"ventas\"\n" +
           "WHERE  id_ventas="+venta.codigo+";");             
